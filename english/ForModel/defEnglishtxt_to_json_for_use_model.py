...
# Leer el texto desde el archivo defsEnglishToFineTuning.txt
with open('defIngles.txt', 'r', encoding='utf-8') as file:
    texto = file.read()
...
with open('defsEnglishToFineTuning.json', 'w', encoding='utf-8') as file:
    file.write(json_data)

print("Archivo defsEnglishToFineTuning.json generado exitosamente.")
