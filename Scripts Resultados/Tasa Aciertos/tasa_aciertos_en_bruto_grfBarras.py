...
roscos_df = pd.read_json('pasapalabra_questions_to_model_gramatical.json')
rae_df = pd.read_json('defsRAE_questions_to_model_gramatical.json')
ingles_df = pd.read_json('defsIngles_questions_to_model_gramatical.json')
